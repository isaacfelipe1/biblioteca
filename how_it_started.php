    ...
    <main class="main-content">
        <section class="about-maria-dolores">
            <div class="about-content">
                <img src="assets/maria-dolores.jpg" alt="Maria Dolores" class="about-image">
                <div class="text-content">
                    ...
                    <a href="#" class="learn-more-link">Conheça a história do Centro Espírita Maria Dolores</a>
                </div>
            </div>
        </section>
        <section class="logo-meaning">
            ...
            <div class="logo-image-container">
                <img src="assets/logo-meaning.jpg" alt="Significado da Logomarca da Biblioteca">
            </div>
        </section>
        <section class="book-loan">
            ...
            <div class="book-images-container">
                <img src="assets/books1.jpg" alt="Acervo de livros 1">
                <img src="assets/books2.jpg" alt="Acervo de livros 2">
                <img src="assets/books3.jpg" alt="Acervo de livros 3">
                <img src="assets/books4.jpg" alt="Acervo de livros 4">
            </div>
